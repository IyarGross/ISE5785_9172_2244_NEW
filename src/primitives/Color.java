 ...
 * The constructors operate with any non-negative RGB values.
 * The colors are maintained without upper limit of 255.
 * Some additional operations are added that are useful for manipulating light's colors.
 * @author Dan Zilberstein
 */
public class Color {
    public static final Color GREEN = new Color(50,190,50) ;
