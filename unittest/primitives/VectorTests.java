...
class VectorTests {
    ...
    void testCrossProduct() {
        ...
        assertNotEquals(v1.length() * v3.length(), vr.length(), "ERROR: crossProduct() wrong result length");
    ...
    void testNormalize() {
        ...
        assertThrows(IllegalArgumentException.class, () -> v.crossProduct(v));
        assertEquals(v.length(), v.dotProduct(u), 1e-10, "ERROR: the normalized vector is not in the same direction as the original one");
    }
}